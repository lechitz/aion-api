...
type RecordController interface {
	...
	ListByTag(ctx context.Context, tagID, userID uint64, limit int, afterEventTime *string, afterID *int64) ([]*model.Record, error)
	CountByTag(ctx context.Context, tagID, userID uint64) (int64, error)
